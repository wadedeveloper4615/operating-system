...
#bug
#file(TO_NATIVE_PATH ${BOOTMANAGER_SOURCE_DIR} BOOTMANAGER_SOURCE_DIR_NATIVE)
#workaround
set(BOOTMANAGER_SOURCE_DIR_NATIVE ${BOOTMANAGER_SOURCE_DIR})
# if(CMAKE_HOST_SYSTEM_NAME STREQUAL "Windows")
#string(REPLACE "/" "\\" BOOTMANAGER_SOURCE_DIR_NATIVE ${BOOTMANAGER_SOURCE_DIR})
#endif()

if((NOT CMAKE_C_COMPILER_ID STREQUAL "Clang") AND (NOT SEPARATE_DBG))
    add_compile_flags("-fdebug-prefix-map=\"${BOOTMANAGER_SOURCE_DIR_NATIVE}\"=ReactOS")
endif()
...
if(CMAKE_VERSION VERSION_LESS 3.4.0)
    ...
    set(CMAKE_ASM_COMPILE_OBJECT "<CMAKE_ASM_COMPILER> ${_compress_debug_sections_flag} -x assembler-with-cpp -o <OBJECT> -I${BOOTMANAGER_SOURCE_DIR}/hosttools/include/asm -I${BOOTMANAGER_BINARY_DIR}/hosttools/include/asm <FLAGS> <DEFINES> -D__ASM__ -c <SOURCE>")
    ...
    set(CMAKE_ASM_COMPILE_OBJECT "<CMAKE_ASM_COMPILER> ${_compress_debug_sections_flag} -x assembler-with-cpp -o <OBJECT> -I${BOOTMANAGER_SOURCE_DIR}/hosttools/include/asm -I${BOOTMANAGER_BINARY_DIR}/hosttools/include/asm <INCLUDES> <FLAGS> <DEFINES> -D__ASM__ -c <SOURCE>")
...
function(CreateBootSectorTarget _target_name _asm_file _binary_file _base_address)
    ...
    add_custom_command(
        OUTPUT ${_object_file}
        COMMAND ${CMAKE_ASM_COMPILER} -x assembler-with-cpp -o ${_object_file} -I${BOOTMANAGER_SOURCE_DIR}/hosttools/include/asm -I${BOOTMANAGER_BINARY_DIR}/hosttools/include/asm ${_includes} ${_defines} -D__ASM__ -c ${_asm_file}
        DEPENDS ${_asm_file})
